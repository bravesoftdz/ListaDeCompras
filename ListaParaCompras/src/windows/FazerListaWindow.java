...
public class FazerListaWindow extends JFrame {
	...
	public FazerListaWindow() {
		...
		btnAdicionarALista.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(todos.isEmpty()){
					...
					JOptionPane.showMessageDialog(null, "Xii gravou o produto na lista não visse.. Pede ajuda ao Caba que fez essa bagaça");
		...
		btnPronto.addActionListener(new ActionListener() {
			...
			JOptionPane.showMessageDialog(null, "Pronto agora é so ir fazer a feira.. Que o programa ainda num faz a feira sozinho não..");
			txtLista.setText("");
			txtProduto.setText("");
			txtQuantidade.setText("");
